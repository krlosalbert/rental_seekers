...
@section('content')
    ...
    <button type="button" id="btn-view_neighborhoods" data-toggle="modal" data-target="#modal-view_neighborhoods" style="display: none;"></button>

    <!-- Modal -->
    <div class="modal fade" id="modal-view_neighborhoods" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header d-flex" id="head_form">
                    <h3 class="modal-title" id="myModalLabel">{{ __('Barrios') }}<h3>
    ...
    <script src="{{ asset('js/neighborhoods/neighborhoods.js') }}"></script>
    @if(session('success'))
        <script>
