        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header" id="head_form">
                    ...
                    <a href="{{ route('supervisors.create') }}" type="button" id="insert" class="btn btn-secondary" data-toggle="" data-target="#exampleModal">
                        Nuevo
                    </a>
                        ...
                        <tbody>
                            <tr>  
                                ...
                                <td class="text-center">
                                    ...
                                    <!-- Button trigger modal para editar -->
                                    <a href=" {{ route('supervisors.create') }}" type="button" id="Update" class="btn btn-warning">
