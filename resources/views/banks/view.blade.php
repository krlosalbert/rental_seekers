...
@section('content')
    ...
    <button type="button" id="btn-view_banks" data-toggle="modal" data-target="#modal-view_banks" style="display: none;"></button>

    <!-- Modal -->
    <div class="modal fade" id="modal-view_banks" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header d-flex" id="head_form">
                    <h3 class="modal-title" id="myModalLabel">{{ __('Bancos') }}<h3>
                    <!-- Button trigger modal el registro de nuevo rol -->
                    <button class="btn btn-secondary form-role" data-toggle="modal" data-target="#form-banks">
                        Nuevo
                    </button>
                        ...
                        <tbody>
                            <tr>  
                                ...
                                <td class="text-center">
                                    ...
                                    <button class="btn btn-warning form-update-role" data-toggle="modal" data-target="#form-update-banks" data-id="{{ $bank->id }}">
    ...
    <script src="{{ asset('js/banks/banks.js') }}"></script>
